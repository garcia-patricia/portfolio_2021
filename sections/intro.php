...
<div class="intro-pic">
        <img src="img/celladore_thumb.jpg" alt="Hi! I'm Patricia Morales. A graphic designer, illustrator and aspiring front-end web developer located in London Ontario!">
</div>

    <div class="intro-text">
        <h1 class="hello-title">
            <?php 
        $items = Array( 'Howdy howdy howdy &#129312;','"Cool. Cool cool cool."','Hello world. &#129302;','[[REDACTED]]','"Stay a while and listen."', '"Hey! Listen!"', '"Good news, everyone!"','"Is mayonnaise an instrument?"', '"Streets ahead!"', '"If you have to ask, you&#x02019;re streets behind."','"Its my whole i-DEAN-tity!"');
