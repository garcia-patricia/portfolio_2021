...
if (mysqli_num_rows($result) > 0) {
  ...
  while($row = mysqli_fetch_assoc($result)) {
    echo "<div class='portfolio-grid'><a href='http://www.google.com/" .$row['project_thumbnail']. "'><img class='thumbnail-image' src='img/" . $row['project_thumbnail'] . " '. data-toggle='modal' data-target='#myModal1' /> ";
